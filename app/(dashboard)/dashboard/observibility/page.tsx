...
export default function ObservibilityPage() {
  return (
    <div className="space-y-6">
      {/* Title */}
      <div>
        <h1 className="text-2xl font-bold">Observibility</h1>
      </div>

      {/* First Row - Metric Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <SummaryCard value="30 ms" label="Tokenization" />
        <SummaryCard value="300 ms" label="Detokenization" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <SummaryCard value="100 m" label="Requests" />
        <SummaryCard value="300 ms" label="Detokenization" />
        <SummaryCard value={1200} label="Vaults" />
        <SummaryCard value="1.2m" label="PII Protected" />
      </div>
